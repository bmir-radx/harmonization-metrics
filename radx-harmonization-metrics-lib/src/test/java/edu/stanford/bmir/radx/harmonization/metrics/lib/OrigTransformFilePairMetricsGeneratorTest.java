...
class OrigTransformFilePairMetricsGeneratorTest {
    ...
    @Test
    public void createMetricsFromFilePair_origOnly() throws InvalidProgramIdentifierException {
        ...
        Mockito.doReturn(nHarmonizableDataElementsOrig).when(mockChecker)
                .countHarmonizableElements(Mockito.any(ProgramIdentifier.class), Mockito.anySet());
        Mockito.doReturn(nHarmonizedDataElementsOrig).when(mockChecker)
                .countHarmonizedElements(Mockito.any(ProgramIdentifier.class), Mockito.anySet());
        ...
        assertEquals(testProgramIdentifier, metrics.programIdentifier());
    ...
    @Test
    public void createMetricsFromFilePair_transformOnly() throws InvalidProgramIdentifierException {
        String fileName = "filename";
        ReducedFileName testName = ReducedFileName.valueOf("testName");
        ProgramIdentifier testProgramIdentifier = ProgramIdentifier.RADXUP;
        StudyId testStudyId = StudyId.valueOf("testStudyId");
    ...
    @Test
    public void createMetricsFromFilePair_origAndTransform() throws InvalidProgramIdentifierException {
        String fileName = "filename";
        ReducedFileName testName = ReducedFileName.valueOf("testName");
        ProgramIdentifier testProgramIdentifier = ProgramIdentifier.RADXUP;
        StudyId testStudyId = StudyId.valueOf("testStudyId");
        ...
        Integer nHarmonizedDataElementsOrig = 1;
        Mockito.doReturn(nHarmonizableDataElementsOrig).when(mockChecker)
                .countHarmonizableElements(Mockito.any(ProgramIdentifier.class), Mockito.eq(origVariableNames));
        Mockito.doReturn(nHarmonizedDataElementsOrig).when(mockChecker)
                .countHarmonizedElements(Mockito.any(ProgramIdentifier.class), Mockito.eq(origVariableNames));
        ...
        Mockito.doReturn(nHarmonizableDataElementsTransform).when(mockChecker)
                .countHarmonizableElements(Mockito.any(ProgramIdentifier.class), Mockito.eq(transformVariableNames));
        Mockito.doReturn(nHarmonizedDataElementsTransform).when(mockChecker)
                .countHarmonizedElements(Mockito.any(ProgramIdentifier.class), Mockito.eq(transformVariableNames));
